...
/** 
 * @ClassName: SendRquest
 * @description: 发送
 * @author: your name
 * @Date: 2019年4月29日 下午2:34:13
 */
...
public class SendRquest {
    ...
    public static String sendPost(String url, String param) {
        ...
        try {
            ...
            // 发送请求参数
            //param = "app=json&mod=user&act=login&username=13828840324&password=123456";
            out.print(param);
            // flush输出流的缓冲
            out.flush();
	...
	public static void main(String[] args) {
		String result = SendRquest.sendPost("https://testserver.comein.cn/comein/index.php",DataStore.postParam);
